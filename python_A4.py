# Write the program to find the second last number in the list
...
# Write the program to find index of an item in tuple
...
# Write the program to convert a tuple if string values to a tuple of integer value
